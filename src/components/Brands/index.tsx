      ...
      <div className="container">
        ...
        />
          <div className="w-full px-4">
            <div className="flex flex-wrap items-center justify-center rounded-sm light:bg-gray-white sm:px-10 md:px-[50px] md:py-[40px] 2xl:py-[60px] bg-white px-8 py-11 shadow-three dark:bg-gray-dark">
