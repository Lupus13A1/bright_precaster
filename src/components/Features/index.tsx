  ...
  return (
    <>
      <section id="features" className="py-16 md:py-20 lg:py-28">
        <div className="container animate-fade-up animate-once animate-duration-[1500ms] animate-delay-100 animate-ease-linear">
          <SectionTitle
            title="CARROUSEL SYSTEM"
            paragraph={translateText('carrousel')}
            center
          />
          <div className="grid grid-cols-1 gap-x-8 gap-y-14 md:grid-cols-2 lg:grid-cols-3 animate-fade-up-once" >
