        ...
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
            <div className="-mx-4 flex flex-wrap items-center">
                ...
                <div
                    ...
                    <img className="hover:opacity-75" src="/images/product/wall4-1.jpg" />
                    <img className="hover:opacity-75" src="/images/product/wall5-1.jpg" />
                    <img className="hover:opacity-75" src="/images/product/wall6-1.png" />
                </div>
